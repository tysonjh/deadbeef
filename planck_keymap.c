 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | GUI  | Home | Alt  | Ctrl |Lower |    Space    |Raise | Ctrl | Alt  | End  | GUI  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_LGUI, KC_HOME, KC_LALT, KC_LCTL, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RCTL, KC_RALT, KC_END,  KC_RGUI}
},
...
[_LOWER] = {
  ...
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_UP,   _______,  KC_PGU},
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGD}
},
